...
var List = /** @class */ (function (_super) {
    ...
    function List(props) {
        ...
        _this.onMove = function (clientX, clientY) {
            ...
            if (_this.props.onMove) {
                _this.props.onMove({ clientX: clientX, clientY: clientY });
            }
        };
        ...
        _this.onEnd = function (e) {
            ...
            if ((_this.props.removableByMove && isOutOfBounds) ||
                (_this.afterIndex > -1 && _this.state.itemDragged !== _this.afterIndex)) {
    ...
    List.prototype.render = function () {
        ...
        var ghostStyle = __assign({}, baseStyle, { top: this.state.targetY, left: this.state.targetX, width: this.state.targetWidth, height: this.state.targetHeight, display: 'block', position: 'fixed', marginTop: 0 });
            ...
            this.props.renderList({
                children: this.props.values.map(function (value, index) {
                    ...
                    var props = {
                        ...
                        style: __assign({}, baseStyle, { visibility: isHidden ? 'hidden' : undefined, zIndex: isSelected ? 5000 : 0 })
                    };
